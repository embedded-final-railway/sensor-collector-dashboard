    ...
    <div className={styles["container"]}>
      <div className={`${styles["main-content"]}`} >
        ...
        <div style={{ gridArea: "frequency_x" }}>
          <FrequencyChart data={accelX} frequency={200} size={1024} title="X-Axis FFT" color="#ff0000" />
        </div>
        <div style={{ gridArea: "frequency_y" }}>
          <FrequencyChart data={accelY} frequency={200} size={1024} title="Y-Axis FFT" color="#00ff00" />
        </div>
        <div style={{ gridArea: "frequency_z" }}>
          <FrequencyChart data={accelZ} frequency={200} size={1024} title="Z-Axis FFT" color="#0000ff" />
        </div>
      </div>
      {isRunning && shaking && (<>
